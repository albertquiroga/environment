...
if [[ $USERNAME == 'ec2-user' ]]; then
  echo 'Your username is ec2-user so this is probably an AWS machine. You will need to create a password for the user. This script will automatically delete back the password at the end.'
